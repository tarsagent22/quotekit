...
export default function UpgradeClient({ initialSpotsLeft }: Props) {
  ...
  // Start with SSR-provided value; refresh client-side in background
  const [spotsLeft, setSpotsLeft] = useState<number>(initialSpotsLeft)

  // Refresh in background after hydration in case count changed since SSR
  useEffect(() => {
